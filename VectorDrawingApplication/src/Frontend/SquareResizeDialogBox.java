...
public class SquareResizeDialogBox extends javax.swing.JDialog {
    Program main;
    Shape shapeToResize;

    
    public SquareResizeDialogBox(java.awt.Frame parent, boolean modal,Shape shape) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SquareResizeDialogBox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
